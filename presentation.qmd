...
# [Section Slide]{.bold .r-fit-text} {.bg-gold .text-center}

This slide is using the `.bg-[insert color]` class change the background color (here `.bg-gold`). You can also use the `.text-color-[insert color]` class to change the text color (for example [`.text-color-white`]{.text-color-white}).
