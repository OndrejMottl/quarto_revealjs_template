...
-   An image: [background-image]{.text-color-background-byzantium}

-   A video: [background-video]{.text-color-background-harvest-gold}

-   An iframe: [background-iframe]{.text-color-background-persian-green}
